...
public class Media {
    ...
    //GUI
    public static Texture squareMenu, mainBack, pinkButton, pauseButton, settingsButton, invButton, quitButton;
    ...
    public static void load_assets(){
        ...
        // Buttons
        pauseButton = new Texture(Gdx.files.internal("gui/pause_button.png"));
        settingsButton = new Texture(Gdx.files.internal("gui/settings_button.png"));
        invButton = new Texture(Gdx.files.internal("gui/inv_button.png"));
        quitButton = new Texture(Gdx.files.internal("gui/quit_button.png"));
    }
